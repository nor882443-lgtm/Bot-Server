...
const serverHost = process.env.SERVER_HOST || 'servereco.aternos.me';
const serverPort = parseInt(process.env.SERVER_PORT || '56279', 10);
const botUsername = process.env.BOT_USERNAME || 'Mcserver';
